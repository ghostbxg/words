<template>
	<div id="words">
		<vue-drawer-layout :drawer-width="180" :drawable-distance="160" :z-index="0" :content-drawable="true" ref="drawerLayout">
			<div class="drawer" slot="drawer">
				<div class="text">
					...
					<div class="text-center pt-4 pb-4">
						...
						<a href="javascript:void(0)" class="btn" @click="handleToggleDrawer">返回</a>
					</div>
				</div>
			</div>
			...
			<div class="content" slot="content">
				<div class="text">
					<div class="text-light text-center" style="background:#49c998 ;padding: 10px;">
						<a style="float: left;color: white;" href="#" @click="handleToggleDrawer">主页</a>
						我的单词本
					...
					<div class="container " style="height:650px;overflow-y:scroll;">
						...
						<div class="my-2 mt-2 d-block border shadow "  v-for="(word,index) in words">
							<div>
								<div class="row">
